        ...
        >
          ...
          <div class="user-details">
            <div class="input-box">
              ...
              <input type="checkbox" name="number_of_ramps[]" value="1" />
              <label for="one">1</label><br />
              <input type="checkbox" name="number_of_ramps[]" value="2" />
              <label for="two">2</label><br />
              <input type="checkbox" name="number_of_ramps[]" value="3" />
              <label for="three">3</label><br />
              <input type="checkbox" name="number_of_ramps[]" value="4+" />
            ...
            <div class="input-box">
              ...
              <input type="checkbox" name="number_of_lanes[]" value="1" />
              <label for="one">1</label><br />
              <input type="checkbox" name="number_of_lanes[]" value="2" />
              <label for="two">2</label><br />
              <input type="checkbox" name="number_of_lanes[]" value="3" />
              <label for="three">3</label><br />
              <input type="checkbox" name="number_of_lanes[]" value="4+" />
              <label for="four">4+</label><br />
              @error('one'||'two'||'three'||'four')
              <div class="text-danger">{{ $message }}</div>
              @enderror
            ...
            <div class="input-box">
              ...
              <input type="checkbox" name="ramp_surface[]" value="Concrete" />
              <label for="concrete">Concrete</label><br />
              <input type="checkbox" name="ramp_surface[]" value="Gravel" />
              <label for="gravel">Gravel</label><br />
              <input type="checkbox" name="ramp_surface[]" value="Dirt" />
              <label for="dirt">Dirt</label><br />
              <input type="checkbox" name="ramp_surface[]" value="Other" />
            ...
            <div class="input-box">
              ...
              <input name="restrooms" value="Yes" type="radio"  />Yes
              <input name="restrooms" value="No" type="radio" checked />No
              @error('restrooms')
              <div class="text-danger">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="input-box">
              ...
              <input name="applicable_image_video_boat" type="file" />
            ...
            <div class="input-box">
              ...
              <div class="rating-wrap">
                ...
                <input type="text" name="boat_ramp_access_rating" style="display: none" id="rating-value">
            </div>
          </div>
</div>
          <div class="button">
