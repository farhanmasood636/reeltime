        ...
        >
          ...
          <div class="user-details">
            <div class="input-box">
              ...
              <input type="checkbox" name="bank_access[]" value="Poor" />
              <label for="poor">Poor</label>
              <br />
              <input type="checkbox" name="bank_access[]" value="Fair" />
              <label for="fair">Fair</label>
              <br />
              <input type="checkbox" name="bank_access[]" value="Good" />
              <label for="good">Good</label>
              <br />
              <input type="checkbox" name="bank_access[]" value="Excellent" />
            ...
            <div class="input-box">
              ...
              <input name="fish_attractors" value="Yes" type="radio" />Yes
              <input name="fish_attractors" value="No" type="radio" checked />No
              <input
                type="text"
            ...
            <div class="input-box">
              ...
              <input name="species" type="text" required /> @error('species')
              <div class="text-danger">{{ $message }}</div>
              @enderror
            </div>
            <div class="input-box">
              <span class="details">Fish Cleaning Station</span>
              <input name="fish_cleaning_station" value="Yes" type="radio" />Yes
              <input
            ...
            <div class="input-box">
              ...
              <input name="dock" id="chk_yes" value="Yes" type="radio" />Yes
              <input name="dock" value="No" type="radio" checked />No
              <input
                style="display: none"
                id="how_many"
                type="text"
            ...
            <div class="input-box">
              ...
              <input name="applicable_image_video_fishing" type="file" />
