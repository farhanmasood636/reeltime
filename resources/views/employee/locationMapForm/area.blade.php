...
<html lang="en" dir="ltr">
  ...
  <body>
        ...
        >
          ...
          <div class="user-details">
            <div class="input-box">
              ...
              <input name="is_camping_allowed" value="Yes" type="radio" />Yes
              <input
            ...
            <div class="input-box">
              ...
              <input type="checkbox" name="allowed_camping_type[]" value="1" />
              <label for="rv">RV</label>
              <br />
              <input type="checkbox" name="allowed_camping_type[]" value="2" />
              <label for="tent">Tent</label>
              <br />
              <input type="checkbox" name="allowed_camping_type[]" value="3" />
              <label for="cabins">Cabins</label>
              <br />
              <input type="checkbox" name="allowed_camping_type[]" value="4+" />
            ...
            <div class="input-box">
              ...
              >
              <input name="is_electricity" value="Yes" type="radio" />Yes
              <input name="is_electricity" value="No" type="radio" checked />No
              <input
                name="is_electricity"
            ...
            <div class="input-box">
              <span class="details">Is There Water At The Campground?</span>
              <input name="is_water" value="Yes" type="radio" />Yes
              <input name="is_water" value="No" type="radio" checked />No
              <input name="is_water" value="Not Applicable" type="radio" />Not
              Applicable @error('is_water')
              <div class="text-danger">{{ $message }}</div>
              @enderror
            </div>
            <div class="input-box">
            ...
            >
              <span class="details">Family Area/Recreation Type</span>
              <input
                type="checkbox"
              ...
              />
              <label for="covered_pavilions">Cover Pavilions</label>
              <br />
              <input
                type="checkbox"
                name="family_area_recreation_type[]"
              ...
              />
              <label for="hiking_walking_trails">Hiking/Walking Trails</label>
              <br />
              <input
                type="checkbox"
                name="family_area_recreation_type[]"
    ...
    <script type="text/javascript">
      ...
      function show2() {
        document.getElementById("picnic_area_amenities").style.display = "none";
      }
      function show3() {
        document.getElementById("family_area_recreation_type").style.display =
          "block";
        document.body.style.height = 1200 + "px !important";
      }
      function show4() {
