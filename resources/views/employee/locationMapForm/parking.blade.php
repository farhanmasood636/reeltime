...
<html lang="en" dir="ltr">
  ...
  <body style="height: 800px !important">
    <div class="container">
      <!-- <div class="back">
        <a href="{{ url('/employee/locationmapform/location-section-two') }}"
          ><i
      ...
      <div class="content">
        <form
          action="{{ route('employee.locationmapform.create.step.three.post') }}"
          method="POST"
          ...
          <div class="user-details">
            ...
            <div class="input-box">
              ...
              <input
                style="display: none"
                type="text"
                name="lighted_parking_type"
                id="lighted_parking_type"
                placeholder="If Yes, Then It Is Poor, Fair, Good, Excellent?"
              />
            ...
            <div class="input-box">
              ...
              <input
                name="applicable_image_video_parking"
                type="file"
                value="None"
              />
