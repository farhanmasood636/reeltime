...
<html lang="en" dir="ltr">
  ...
  <body style="height: 800px !important">
    <div class="container">
      <!-- <div class="back">
        <a href="{{ url('/employee/locationmapform/location-section-three') }}"
          ><i
      ...
      <div class="content">
        <form
          action="{{ route('employee.locationmapform.create.step.four.post') }}"
          method="POST"
        ...
        >
          ...
          <div class="user-details">
            ...
            <div class="input-box">
              ...
              <input
                type="text"
                name="specify_sunrise_to_sunset_access"
            ...
            <div class="input-box">
              ...
              <input
                style="display: none"
                type="text"
                name="open_year_round_specify"
                id="open_year_round_specify"
                placeholder="If Other, Then Specify!"
              />
            ...
            <div class="input-box">
              ...
              <input
                style="display: none"
                type="text"
                name="closed_months_specify"
                id="closed_months_specify"
                placeholder="If Other, Then Specify!"
              />
            ...
            <div class="input-box">
              ...
              <input
                style="display: none"
                type="text"
                name="often_hours_of_use_specify"
                id="often_hours_of_use_specify"
    ...
    <script type="text/javascript">
      ...
      function show2() {
        document.getElementById("open_year_round_specify").style.display =
          "none";
      }
      function show3() {
        document.getElementById("closed_months_specify").style.display =
          "block";
      }
      function show4() {
      ...
      function show5() {
        document.getElementById("often_hours_of_use_specify").style.display =
          "block";
      }
      function show6() {
        document.getElementById("often_hours_of_use_specify").style.display =
